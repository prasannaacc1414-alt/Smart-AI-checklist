...
import { Send, Mic, MicOff, AlertCircle, Sparkles, User, Bot, Loader2, Volume2, VolumeX } from 'lucide-react';
...
export default function VoiceInput({ messages, onSendMessage, isLoading, errorMsg }: VoiceInputProps) {
  ...
  return (
    <div id="smart-interaction-panel" className="bg-white rounded-2xl border border-slate-200/80 shadow-sm flex flex-col h-[520px] overflow-hidden">
      ...
      <div id="chat-header" className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-medium text-slate-500 uppercase tracking-wider font-mono">Active</span>
          </div>
        </div>
      </div>
      ...
      <div id="chat-messages-scroll" className="flex-1 overflow-y-auto p-5 space-y-4 scrollbar-thin bg-slate-50/30">
        ...
        {errorMsg && (
          <div id="ai-global-error" className="flex gap-3 max-w-[85%] mx-auto bg-amber-50 border border-amber-200/70 p-3.5 rounded-xl text-xs text-amber-800 font-medium">
